...
double simd(size_t n) {
  ...
  __m256d signal_vector = _mm256_set_pd(1, -1, 1, -1);
  __m256d one_vector = _mm256_set1_pd(1);
  __m256d two_vector = _mm256_set1_pd(2);
  __m256d four_vector = _mm256_set1_pd(4);
  __m256d result_vector = _mm256_setzero_pd();
  __m256d sum_vector = _mm256_setzero_pd();
  __m256d idx_vector = _mm256_set_pd(0, 1, 2, 3);
